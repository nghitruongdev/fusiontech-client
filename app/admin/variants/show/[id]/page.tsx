            ...
            <div className="grid grid-cols-2">
                <div className="">
                    ...
                    <div className="">
                        ...
                        {firstImage && (
                            <Image sx={{ maxWidth: 300 }} src={firstImage} alt={product?.name} />
                        )}
                    </div>
                    <div className="flex">
                        {record?.images?.map((item: any, idx) => (
                            <Image sx={{ maxWidth: 50 }} src={item} key={item} alt={`${product?.name}-${idx}`} />
                        ))}
                    </div>
                </div>
                <div className="">
                    ...
                    <p>Not implemented show specifications variant</p>
                    <Heading as="h5" size="sm" mt={4}>
                        Product Info
                    </Heading>
