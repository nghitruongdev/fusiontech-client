...
const ForgotPasswordForm = () => {
    ...
    const onResetMail = async ({ email }: any) => {
        const result = await firebaseAuthProvider().forgotPassword?.(email);
        on();
    };
    return (
        <AuthPage
    ...
    //                     <Stack align={"center"} spacing={2}>
    //                         <Text fontSize={"sm"} color={"gray.500"}>
    //                             Khôi phục mật khẩu sử dụng địa chỉ email đã đăng
    //                             ký tại FusionTech
    //                         </Text>
    //                     </Stack>
    //                     <Stack
    ...
    //                             </p>
    //                             <p>
    //                                 Vui lòng kiểm tra email và làm theo hướng
    //                                 dẫn để có thể khôi phục mật khẩu.
    //                             </p>
    //                         </Box>
    //                         <Button
    //                             as={Link}
