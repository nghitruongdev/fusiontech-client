      ...
      <div className="">
        <ul className="mt-3 space-y-3 ">
          ...
          >
            <li
              className={`flex items-center mt-2 hover:bg-gray-200 hover:text-blue-700 hover:font-semibold hover:rounded-lg ${
                currentPath === '/account/profile' ? 'text-blue-700 font-semibold' : ''
              }`}
          ...
          >
            <li
              className={`flex items-center mt-2 hover:bg-gray-200 hover:text-blue-700 hover:font-semibold hover:rounded-lg ${
                currentPath === '/account/orders' ? 'text-blue-700 font-semibold' : ''
              }`}
          ...
          >
            <li
              className={`flex items-center mt-2 hover:bg-gray-200 hover:text-blue-700 hover:font-semibold hover:rounded-lg ${
                currentPath === '/account/favorites' ? 'text-blue-700 font-semibold' : ''
              }`}
