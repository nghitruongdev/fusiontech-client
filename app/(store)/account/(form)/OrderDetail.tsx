...
import { BiChevronLeft,
         BiChevronRight } from "react-icons/bi";
...
const OrderDetailPage = () => {
  ...
  const handleClick = () => {
    navigate('/account/order-form');
  };
    
  return (
    <div className="mx-auto ">
        <div className="flex items-center">
            <button className='bg-white rounded-md mr-2 hover:bg-blue-700 ' onClick={handleClick}>
        ...
        <div className="w-1/2 p-4 bg-white rounded-md">
          ...
          <div>
            ...
            <p className="">
              <span className="text-sm font-semibold">Trạng thái đơn hàng:</span> 
            </p>
          </div>
        </div>
    </div>
      ...
      <div className="mt-4 p-4  bg-white rounded-md">
        ...
        <div className="container items-start border border-spacing-2 rounded-md p-4">
            <div  className="flex mb-2 ">
              ...
              <p className="text-white text-xs p-1 ml-2 rounded-md bg-red-600">ĐÃ HỦY</p>
            </div>
            <div className="flex items-center">
                <p className='text-blue-500 text-sm'>Xem chi tiết vận đơn  </p>
        ...
        <div className="flex  mt-4">
            <div className=" border border-spacing-2 rounded-md">
                <img src="https://lh3.googleusercontent.com/Ezh1zisXToaMPP30pXE50dnotXpEyxnGsYpbd6uZc6jEWRWhMrMY2EDuXNcWPhw4nfcwwC-mGGVEkkRtRSJE0P3hRPuvCjw=rw"
                alt="imageProduct" className='w-20 h-20 ' />
            </div>
            <div className='ml-2'>
