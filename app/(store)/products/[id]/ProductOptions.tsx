...
// type OptionStore = ReturnType<typeof createOptionStore>;

// const createOptionStore = (initProps?: Partial<StoreProps>) => {
//     return createStore(
//         immer<State>((set, get) => ({
//             groups: {},
//             selected: {},
...
// function useOptionContext<T>(
//     selector: (state: State) => T,
//     equalityFn?: (left: T, right: T) => boolean,
// ): T {
//     const store = useContext(OptionContext);
//     if (!store) throw new Error("Missing BearContext.Provider in the tree");
//     return useStore(store, selector, equalityFn);
// }

// const OptionContext = createContext<OptionStore | null>(null);

// const OptionProvider = ({
//     children,
//     ...props
// }: PropsWithChildren<Partial<StoreProps>>) => {
//     const storeRef = useRef<OptionStore>();
//     if (!storeRef.current) {
//         storeRef.current = createOptionStore(props);
//     }
//     const addGroup = ({ name, values }: OptionGroup) =>
//         storeRef.current?.setState(({ groups }) => {
//             groups[name] = values;
//         });

//     return (
//         <OptionContext.Provider value={storeRef.current}>
//             {children}
