...
const Description = () => {
  return (
    <div className='[h-screen] overflow-auto'>
      ...
      <div className='container mx-auto space-y-4 mb-4 overflow-y-scroll pl-2'>
        <div className='appearance'>
          ...
          <div className=' grid gap-3 mt-2'>
            <p className='text-sm'>
              Khi cầm trên tay laptop HP 15s-fq2712TU thì điều đầu tiên làm mình
              ấn tượng đó chính là thiết kế của chiếc máy này quá nhỏ gọn và
              thanh lịch. Laptop HP 15s sở hữu thiết kế tinh tế, các đường bo
        ...
        <div className='performance'>
          ...
          <div className=' grid gap-3 mt-2'>
            <p className=' text-sm'>
              Laptop HP 15s-fq2712TU mang trong mình bộ vi xử lý tiên tiến Intel
              Core i3 gen 11 Tiger Lake được sản xuất trên tiến trình 10nm. Con
              chip i3 1115G4 sở hữu 2 nhân, 4 luồng tốc độ cơ bản 1,70GHz và đạt
              tốc độ tối đa lên đến 4.1Ghz. Với bộ vi xử lý này thì bạn có thể
        ...
        <div className='display'>
          ...
          <div className=' grid gap-3 mt-2'>
            <p className=' text-sm'>
              Màn hình máy tính HP 15s có kích thước lớn lên đến 15.6 inch và độ
              phân giải 1366 x 768 Pixels sắc nét. HP 15s-fq2712TU sử dụng tấm
              nền IPS, công nghệ BrightView Micro-edge giúp nâng cao trải nghiệm
              hình ảnh của người dùng. Về độ sáng thì máy có độ sáng tương đối ở
              mức 250 nits, khá phổ thông trên những mẫu laptop giá rẻ. Với độ
              sáng này thì bạn cũng nên hạn chế làm việc ở ngoài trời hoặc trong
