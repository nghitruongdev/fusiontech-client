...
const ProductListWithCategory = async () => {
        ...
        <>
            <div className="flex justify-between">
                ...
                <div className=" flex justify-end ">
                    <button className="px-3 mr-1 py-1 rounded-full bg-zinc-200">
                        *Brand name*
                    </button>
                    <button className="px-3 ml-1 rounded-full bg-zinc-200">
                        Xem tất cả
                    </button>
                </div>
            </div>
            <div
                ...
                className="lg:col-span-3 overflow-y-auto h-[650px] grid grid-cols-6 gap-4"
            >
