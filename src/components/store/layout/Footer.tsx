        ...
        <SimpleGrid
          ...
          <Stack spacing={6}>
            <div className='navBarHover flex items-center justify-center border-2 w-40  hover:bg-white hover:text-blue-600'>
              <Link href='/'>
                <button className='font-extrabold text-xl '>FusionTech</button>
              </Link>
            </div>
            ...
            <Text fontSize={'sm'}>
              Copyright © {new Date().getFullYear()} FusionTech. All Rights
              Reserved.
            </Text>
            <Stack
              direction={'row'}
    ...
    <Stack>
      ...
      <form action='#'>
        <Box position='relative'>
          <Input
            ...
            placeholder='Đăng ký nhận khuyến mãi'
            _focus={{ outline: 0 }}
            color='gray.100'
            borderWidth={0}
          />
      ...
      <Box className='flex justify-center items-center'>
        <div className='rounded-md p-2 flex items-center justify-center '>
          <Link href='/thank-you'>
            <button className='font-extrabold text-sm hover:underline hover:underline-offset-auto'>
              Chân thành cảm ơn!
            </button>
          </Link>
        </div>
