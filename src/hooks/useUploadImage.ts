...
const useUploadImage = ({ resource }: { resource: keyof typeof IMAGE_BASE_PATH }) => {
...
// {url, path, basePath}:{basePath: keyof typeof IMAGE_BASE_PATH, url?:string, path?:string}
function getName(basePath: keyof typeof IMAGE_BASE_PATH, url?:string, path?:string){
